...
<form action="tupdate2.php" method="POST">
<fieldset>
...
<?php
	...
	if($id && $name && $designation && $grade && $subject)
	{
		...
		$query=mysql_query("update teacher set id='$id', name='$name', designation='$designation', grade='$grade', subject='$subject' where id='$conid'");
		
		header("location:tupdate1.php?notify=Teacher have been updated.");
	}
	else
	{
		echo header("location:tupdate2.php?notify=All fields are required.");
	}
	 }
?>
