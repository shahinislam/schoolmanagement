<html>
<head>
<link rel="stylesheet" type="text/css" href="tupdate1.css">
</head>
<body>
<h1>Update Teacher Information<h1>

<form action="tupdate1.php" method="POST">
...
if(isset($_POST['ok']))
{
	...
	{
		echo header("location:tupdate1.php?notify=All fields are required.");
	}
}
?>
