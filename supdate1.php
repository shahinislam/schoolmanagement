<html>
<head>
<link rel="stylesheet" type="text/css" href="supdate1.css">
</head>
<body>
<h1>Update Student Information<h1>

<form action="supdate1.php" method="POST">
...
if(isset($_POST['ok']))
{
	...
	{
		echo header("location:supdate1.php?notify=All fields are required.");
	}
}
?>
